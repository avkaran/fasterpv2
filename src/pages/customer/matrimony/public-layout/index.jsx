                ...
                <div>
                                    ...
                                    <div className="d-flex justify-content-end ">
                                        <nav className="nav-menu">
                                            <ul>
                                                ...
                                                <li className="nav-item"><a className="nav-link" href="#/public/search">Search</a></li>
                                                <li className="nav-item"><a className="nav-link" href="#/public/register">Free Register</a></li>
                                                <li className="nav-item"><a className="nav-link" href="#/public/login">Login</a>
                                                </li>
                                                <li className="nav-item"><a className="nav-link" href="#/public/membership">Membership</a>
                                                </li>
                    ...
                    <div className="content">
                        <Spin spinning={!updateStatus}>
                            {updateStatus && routes.map(item => <Route key={item.title}  {...item} />)}
                        </Spin>
                    </div>
