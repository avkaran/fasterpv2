...
import AddPackage from './addEditPackageDiscount';
import AddEditPackageDiscount from './addEditPackageDiscount';
import ViewPackageDiscount from './viewPackageDiscount';
...
const {userId}=useParams();
    ...
    const [heading] = useState('Package Discount');
    ...
    const tableColumns = [
        ...
        },
        {
           ...
           // key: 'percentage',
            render: (item) => <span>{item.percentage}%</span>,
        },
        {
            title: 'Discount for',
            dataIndex: 'plan_name',
        ...
        },
        {
            ...
            render: (item) => <Space>
                ...
                title={heading}
                    ...
                    dataItem={{ id: item.id,discount_title:item.discount_title, percentage: item.percentage, discount_for: item.plan_name }}
