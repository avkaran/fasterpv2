                ...
                <Spin spinning={initLoading} >
                    ...
                    >
                        <PaginatedTable
                            ...
                            listQuery={"select *,@rownum:=@rownum+1 as row_num from hospital_members CROSS JOIN (SELECT @rownum:={rowNumberVar}) c where status=1 " + context.psGlobal.getWhereClause(filterColumns.current, false)}
                            itemsPerPage={10}
                        />
                    </Card>
                </Spin>
