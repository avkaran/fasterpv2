...
const Home = () => {
    ...
    useEffect(() => {
       navigate('/0/customer/editprofile')
    }, []);
                            ...
                            <div class="col-xl-8 col-xxl-9 col-lg-8">
                                <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                                    ...
                                    <div class="card-body p-0 mt-3 position-relative">
                                        <figure class="avatar position-absolute ms-2 mt-1 top-5"><img src={avg} alt="image" class="shadow-sm rounded-circle w30"/></figure>
                            ...
                            <div class="col-xl-4 col-xxl-3 col-lg-4 ps-lg-0">
                                <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                                    ...
                                    <div class="card-body d-flex pt-4 ps-4 pe-4 pb-0 border-top-xs bor-0">
                                        <figure class="avatar me-3"><img src={avg} class="shadow-sm rounded-circle w45" /></figure>
