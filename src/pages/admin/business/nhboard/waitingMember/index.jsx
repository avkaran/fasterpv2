                ...
                <Spin spinning={initLoading} >
                    ...
                    >
                        <PaginatedTable
                            ...
                            countQuery={"select count(*) as count from hospital_members where status=1 and member_status = 'waiting'" + context.psGlobal.getWhereClause(filterColumns.current, false)}
                            listQuery={"select *,@rownum:=@rownum+1 as row_number from hospital_members CROSS JOIN (SELECT @rownum:={rowNumberVar}) c where status=1 and member_status = 'waiting'" + context.psGlobal.getWhereClause(filterColumns.current, false)}
                            itemsPerPage={10}
                        />
