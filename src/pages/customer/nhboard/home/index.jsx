        ...
        var reqData = [
            {
                ...
                query: "select * from contents where type='article' and status='1' and content_status='published' order by created_date desc"
            },
            {
                query_type: 'query', //query_type=insert | update | delete | query
    ...
    return (
        <>
            <div class="main-content right-chat-active">
                ...
                <div class="row feed-body" style={{ paddingTop: '20px' }}>
                        ...
                        {data.map(item => {
                            return <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                <div class="card-body p-0 d-flex">{item.feature_img}
                                    <figure class="avatar me-3"><img src={item.feature_image ? context.baseUrl + item.feature_image : context.noImg} alt="image" class="shadow-sm rounded-circle w45" /></figure>
     ...
     <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu2">
         ...
         <div class="card-body p-0 d-flex mt-2">
             ...
             <h4 class="fw-600 mb-0 text-grey-900 font-xssss mt-0 me-4">Unfollow Group <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                ...
                                {item.feature_image ? <div class="card-body p-0 d-flex"><Image src={context.baseUrl + item.feature_image} /></div> : ''}
