...
import AddEditFranchise from './addEditFranchise';
...
const Franchise = (props) => {
    ...
    const onFinishDelete=(id)=>{
        ...
        var reqData = { 
            query_type: 'update',
            table:'vi_users',
            where:{ref_id:id,ref_table_column:"franchise.id"},
            values:{status:0}
    ...
    const tableColumns = [
        ...
        // },
        {
            ...
            render: (item) => <Tag color={item.franchise_status === 'Active' ? 'green' : 'red'} style={{ fontWeight: 'bold' }}>{item.franchise_status}</Tag>,
        },
        {
            title: 'Actions',
            // dataIndex: 'actions',
            ...
            render: (item) => <Space>
                ...
                title={heading}
                    ...
                    dataItem={{ id: item.id,franchise_code:item.franchise_code, name: item.name, mobile_no: item.mobile_no }}
