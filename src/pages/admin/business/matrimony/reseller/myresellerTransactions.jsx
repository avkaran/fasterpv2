...
import ResellerTransactions from "./resellerTransactions";
const MyResellerTransactions = (props) => {
    ...
    return (
        <>
            ...
            >
                ...
                <ResellerTransactions resellerType={context.adminUser(userId).role} userId={userId}/>
            </Content>
        </>
    )
}
export default MyResellerTransactions;