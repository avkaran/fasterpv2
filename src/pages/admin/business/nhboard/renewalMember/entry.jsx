...
const RenewalEntry = (props) => {
    ...
    const onMemberFormFinish = (values) => {
        ...
        axios.post('/v1/admin/paymentrenewalentry', form).then(res => {
    ...
    const loadMemberCounts = (d) => {
        setLoader(true);
        axios.post('v1/admin/getsubscription?mstatus=RENEW').then(res => {
            if (res['data'].status == '1') {
    ...
    return (
        <>
            ...
            >
                ...
                <Card title="Renewal Payment" headStyle={{ backgroundColor: '#1F5F54', color: '#ffffff' }} >
