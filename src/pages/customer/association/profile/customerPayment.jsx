            ...
            >
                <div>
                    <Spin spinning={loader}>
                        ...
                        {
                            context.customerUser.payment_status === 'unpaid' && (<><Row style={{ marginBottom: '10px' }}>
                                <Col xs={24} xl={4}>
                                ...
                                <Col xs={24} xl={20}>
                                    <table style={{ width: '100%' }}>
                                        <tr>
                                            <td colspan="2" style={{ color: cyan[7] }}> Our Subscription Bank Account</td>
                        ...
                        }
                        {
                            context.customerUser.payment_status === 'waiting' && (
                                <><Row>
                                    Thanks for yor payment we will approve your profile soon. Relogin if you confirm admin approved. <br />
                                </Row>
