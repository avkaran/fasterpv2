        ...
        <>
          {
            viewData && (<><Row gutter={16} align="center">
                ...
                <br/>
                <span style={{ color: yellow[6], fontWeight: 'bold' }}> 1 credit will be deducted when viewing contact. Are you sure?</span>
                <br/>
                <br/>
               <MyButton type="primary" loading={loading} onClick={(viewData)=>onContactViewClick(viewData)}>View Contact</MyButton>
            </Row>
