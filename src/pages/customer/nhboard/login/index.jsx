        ...
        return (
            ...
            <>
             {!updateStatus && (<><Spin spinning={true}/></>)}
              {updateStatus && (<> <div class="site-main mainpad" style={{padding: '10px 0 0 0px'}}>
                            ...
                            <Row gutter={32}>
                                ...
                                <Col className='gutter-row' xs={24} xl={12}>
                                    <Spin spinning={loginLoader}>
                                        <Card title="Login" headStyle={{ backgroundColor: '#0b0c26', color: '#ffffff' }}>
                                            <Form
                                                name="basic"
                                                form={loginForm}
                                                labelAlign="left"
            ...
            </div><OTPLogin show={showOTPLogin} onCancel={() => setShowOTPLogin(false)} onLoginSuccess={onOTPLoginSuccess} /></>)} <br></br> </>
