...
const BrokerProfile = (props) => {
  ...
  const loadViewData = (id) => {
    ...
    var reqData = {
      query_type: "query",
      query:
        "select e.* ,u.username,u.password,u.active_status from brokers e,vi_users u where e.status=1 and u.status=1 and u.ref_table_column='brokers.id' and e.id=u.ref_id and u.ref_id=" +
        id,
    };
    context.psGlobal
  ...
  const ChangePassOnFinish = (values) => {
    ...
    if (
      ...
      var reqData = {
        query_type: "update",
        table: "vi_users",
        where: { ref_id: viewId, ref_table_column: "brokers.id" },
          ...
          <Card
            ...
            extra={
              <MyButton onClick={() => setCurAction("edit")}>
                <i className="fa-solid fa-pencil pe-2"></i>Broker Profile
              </MyButton>
            }
          >
                ...
                >
                  ...
                  <Row gutter={16} style={{ marginTop: "10px" }}>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Broker Code">
                        {viewData.broker_code}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                    ...
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Office Name">
                        {viewData.office_name}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                    ...
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Handling Religion">
                        {viewData.handling_religion}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="handling Caste">
                        {viewData.handling_caste}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="website">
                        {viewData.website}
                      </FormViewItem>
                    ...
                    <Col className="gutter-row" xs={24} xl={12}></Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Broker Country">
                        {viewData.broker_country}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Broker District">
                        {viewData.broker_country}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Broker State">
                        {viewData.broker_state}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
                      <FormViewItem label="Broker Status">
                        {viewData.broker_status}
                      </FormViewItem>
                    </Col>
                    <Col className="gutter-row" xs={24} xl={12}>
